...
export function ScreenshotButton({onScreenshotTook, screenshot} : ScrenshotButtonProps) {
    ...
    return (
        <button
            ...
            type="button"
        >
            { isTakingScreenshot ? <Loading></Loading> : 
                <Camera className="w-6 h-6 text-zinc-100"></Camera>
            }
        </button>
    )
}