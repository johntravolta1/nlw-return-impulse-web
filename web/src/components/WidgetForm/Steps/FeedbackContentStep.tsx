    ...
    return (
        ...
        <header>
            ...
            <span className="text-xl leading-6 flex items-center gap-2">
                <img className="w-6 h-6" src={feedbackTypeInfo.image.source} alt={feedbackTypeInfo.image.source} />
        ...
        <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
            <textarea 
                ...
                focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline 
